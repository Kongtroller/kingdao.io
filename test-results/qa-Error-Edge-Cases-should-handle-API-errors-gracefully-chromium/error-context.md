...
- Name: Error & Edge Cases >> should handle API errors gracefully
- Location: C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:141:7
...
Locator: locator('[data-testid="error-banner"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('[data-testid="error-banner"]')

    at C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:146:64
```
