...
- Name: Theme & Styling >> should handle theme switching
- Location: C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:103:7
...
Call log:
  - waiting for locator('[data-testid="theme-switch"]')

    at C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:105:16
```
