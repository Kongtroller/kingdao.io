...
- Name: Routes & Navigation >> should load DAO Dashboard
- Location: C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:13:7
...
Expected string: "http://localhost:3000/dashboard/dao"
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:15:24
```
