...
- Name: Data Fetching >> should show KING price chart
- Location: C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:31:7
...
Locator: locator('[data-testid="price-chart"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('[data-testid="price-chart"]')

    at C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:33:63
```
