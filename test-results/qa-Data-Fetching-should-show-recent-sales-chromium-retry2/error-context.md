...
- Name: Data Fetching >> should show recent sales
- Location: C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:37:7
...
Locator: locator('[data-testid="recent-sales"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('[data-testid="recent-sales"]')

    at C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:40:29
```
