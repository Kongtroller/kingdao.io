...
- Name: DAO Overview & Tabs >> should filter crypto by category
- Location: C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:88:7
...
Call log:
  - waiting for locator('[data-testid="tab-crypto"]')

    at C:\Users\Nate\Kongtroller\kingdao.io\scripts\qa.test.ts:90:16
```
